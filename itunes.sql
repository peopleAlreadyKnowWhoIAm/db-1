...
-- -----------------------------------------------------
-- Table `itunes`.`user_playlist_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `itunes`.`user_playlist_info` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `itunes`.`playlist_has_song` (
  ...
  INDEX `fk_user's_playlist_info_has_song_user's_playlist_info1_idx` (`user_playlist_info_id` ASC) VISIBLE,
  CONSTRAINT `fk_user's_playlist_info_has_song_user's_playlist_info1`
    FOREIGN KEY (`user_playlist_info_id`)
    REFERENCES `itunes`.`user_playlist_info` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `itunes`.`album_commercial`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `itunes`.`album_commercial` (
  `album_id` INT NOT NULL,
  `price` DECIMAL(8,2) NOT NULL,
  `num_of_downloads` INT NOT NULL,
...
-- -----------------------------------------------------
-- Data for table `itunes`.`user_playlist_info`
-- -----------------------------------------------------
START TRANSACTION;
USE `itunes`;
INSERT INTO `itunes`.`user_playlist_info` (`id`, `user_id`, `name`) VALUES (1, 2, 'Super muzlo');
INSERT INTO `itunes`.`user_playlist_info` (`id`, `user_id`, `name`) VALUES (2, 5, 'Puper muzlo');
INSERT INTO `itunes`.`user_playlist_info` (`id`, `user_id`, `name`) VALUES (3, 6, 'Super puper muzlo');
...
START TRANSACTION;
USE `itunes`;
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (1, 1);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (1, 2);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (1, 3);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (1, 5);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (2, 5);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (2, 9);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (2, 8);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (2, 4);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (2, 3);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (3, 9);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (3, 11);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (3, 12);
INSERT INTO `itunes`.`playlist_has_song` (`user_playlist_info_id`, `song_id`) VALUES (3, 15);
...
-- -----------------------------------------------------
-- Data for table `itunes`.`album_commercial`
-- -----------------------------------------------------
START TRANSACTION;
USE `itunes`;
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (1, 5, 545424);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (2, 10, 5845566);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (3, 7, 4555455);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (4, 1, 54545678);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (5, 22, 455665466);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (6, 10, 545555);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (7, 12, 565645456);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (8, 8, 455664222);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (9, 7, 22655455);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (10, 11, 545566);
INSERT INTO `itunes`.`album_commercial` (`album_id`, `price`, `num_of_downloads`) VALUES (11, 13, 54456565);
